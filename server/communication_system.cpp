...
#pragma comment(lib, "ws2_32.lib")
    ...
    GroundControl::GroundControl(int port) : port_(port), listenSocket_(INVALID_SOCKET) {}
    ...
    bool GroundControl::SendMessage(const std::string& message) { // no idea what this looks like atm
